...
public class CommonTopBar extends RelativeLayout implements View.OnClickListener {
    ...
    public View getRightFirstCustomLayout(int resourceID) {
        return mRightFirButtonLayoutHolder.findViewById(resourceID);
    }

    public View getRightSecCustomLayout(int resourceID) {
        return mRightSecButtonLayoutHolder.findViewById(resourceID);
    }

    public View getRightThirCustomLayout(int resourceID) {
        return mRightThirButtonLayoutHolder.findViewById(resourceID);
    }
